...
const picturesReview = new Component({
  selector: '#main',
  template: `
    ...
    <div class="container review-c">
      <div class="review-img-c">
        <img data-id="1" class="review-img pictures-review__images" src="./images/img/{{image-1}}.webp">
      </div>

       <div class="review-img-c">
        <img data-id="2" class="review-img pictures-review__images" src="./images/img/{{image-2}}.webp">
      </div>

       <div class="review-img-c">
        <img data-id="3" class="review-img pictures-review__images" src="./images/img/{{image-3}}.webp">
      </div>

       <div class="review-img-c">
        <img data-id="4" class="review-img pictures-review__images" src="./images/img/{{image-4}}.webp">
      </div>

       <div class="review-img-c">
        <img data-id="5" class="review-img pictures-review__images" src="./images/img/{{image-5}}.webp">
      </div>

       <div class="review-img-c">
        <img data-id="6" class="review-img pictures-review__images" src="./images/img/{{image-6}}.webp">
      </div>

       <div class="review-img-c">
        <img data-id="7" class="review-img pictures-review__images" src="./images/img/{{image-7}}.webp">
      </div>

       <div class="review-img-c">
        <img data-id="8" class="review-img pictures-review__images" src="./images/img/{{image-8}}.webp">
      </div>

       <div class="review-img-c">
        <img data-id="9" class="review-img pictures-review__images" src="./images/img/{{image-9}}.webp">
      </div>

       <div class="review-img-c">
        <img data-id="10" class="review-img pictures-review__images" src="./images/img/{{image-10}}.webp">
      </div>
    </div>
  ...
  `,
  placeholders: [
    { ph: 'some', code: 'pictures-review' },
    { ph: 'image-1', code: 'pictures-review', data: 0 },
    { ph: 'image-2', code: 'pictures-review', data: 1 },
    { ph: 'image-3', code: 'pictures-review', data: 2 },
    { ph: 'image-4', code: 'pictures-review', data: 3 },
    { ph: 'image-5', code: 'pictures-review', data: 4 },
    { ph: 'image-6', code: 'pictures-review', data: 5 },
    { ph: 'image-7', code: 'pictures-review', data: 6 },
    { ph: 'image-8', code: 'pictures-review', data: 7 },
    { ph: 'image-9', code: 'pictures-review', data: 8 },
    { ph: 'image-10', code: 'pictures-review', data: 9 },
  ...
  events: [
    { type: 'click', selector: '.pictures-review__images', callbacks: [goToPicturesInfo] },
  ],
});

function goToPicturesInfo(e) {
  // добавляет в стейт айди картины, по которой кликнули
  observable2.state.lastPicturesReviewImageID = e.target.dataset.id;
  ...
  const picturesRes = JSON.parse(localStorage.getItem('picturesResult'));
  if (picturesRes[catID][imgID - 1].res !== null) {
    window.location.hash = '#pictures-info';
  };
};

function addBlur() {
  document.querySelectorAll('.pictures-review__images').forEach(e => {
