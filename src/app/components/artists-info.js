...
const artistsInfo = new Component({
  ...
  `,
  placeholders: [
    { ph: 'author', code: 'artists-info', data: 'author' },
    { ph: 'name', code: 'artists-info', data: 'name' },
    { ph: 'year', code: 'artists-info', data: 'year' },
    { ph: 'image', code: 'artists-info', data: 'imageNum' },
  ],
});
